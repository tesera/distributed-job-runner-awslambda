...
var Job = function (options) {
    ...
    self.workerClient = 'curl -o- ' + options.job.install + ' | bash';
    // self.workerClient = 'curl -o- https://raw.githubusercontent.com/tesera/queue2worker-awslambda/bootstrap/tmp/install-client.sh | bash';
};
